...
public class AuthTestAdmin {
    ...
    @Test
    @DisplayName("Should get error message if login with blocker registered user")
    void shouldGetErrorLoginIfBlockerUser() {
    ...
    @Test
    @DisplayName("Should get error message if login with not register user")
    void shouldGetErrorIfNotRegisterUser() {
    ...
    @Test
    @DisplayName("Should get error message if login wrong login")
    ...
    @Test
    @DisplayName("Should get error message if password wrong password")
